...
https://github.com/muntakim1/academic-writing-coach/raw/main/demo/academic-writing-coach-demo.mp4

*79-second demo with narration. If the embed does not play, the file is in [`demo/`](demo/).*
